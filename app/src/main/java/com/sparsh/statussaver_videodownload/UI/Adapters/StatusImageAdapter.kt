...
class StatusImageAdapter(private var images: List<String>, private val activity: AppCompatActivity) :
    RecyclerView.Adapter<StatusImageAdapter.StatusViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): StatusViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_image_s, parent, false)
    ...
    override fun onBindViewHolder(holder: StatusViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            ...
            val intent = ImagePreviewActivity.newIntent(context, images, position, ImagePreviewActivity.FRAGMENT_STATUS)
