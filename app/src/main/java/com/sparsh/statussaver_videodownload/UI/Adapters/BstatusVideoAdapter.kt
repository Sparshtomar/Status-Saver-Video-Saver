...
class BstatusVideoAdapter(private var videos: List<String>, private val activity: AppCompatActivity) :
    RecyclerView.Adapter<BstatusVideoAdapter.BStatusVideoViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BStatusVideoViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_video_b, parent, false)
        return BStatusVideoViewHolder(view)
    }

    override fun onBindViewHolder(holder: BStatusVideoViewHolder, position: Int) {
        val videoPath = videos[position]
        Log.d("StatusImageAdapter", "Loading video: $videoPath")
        ...
        holder.itemView.setOnClickListener {
            ...
            val intent = VideoPreviewActivity.newIntent(context, videos, position, VideoPreviewActivity.FRAGMENT_BUSINESS)
    ...
    inner class BStatusVideoViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
